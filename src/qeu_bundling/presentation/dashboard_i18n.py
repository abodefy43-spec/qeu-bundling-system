...
def dashboard_ui_text_ar() -> dict[str, object]:
    ...
    return {
        ...
        "new_prediction_ar": "توصية جديدة",
        "new_prediction_en": "New Prediction",
        "shuffle_all_ar": "إعادة توزيع الكل",
        "shuffle_all_en": "Shuffle All",
        "refresh_data_ar": "تحديث البيانات",
        "refresh_data_en": "Refresh Data",
        "refresh_running_ar": "جاري التحديث...",
        ...
        "copurchase_fallback_ar": "بديل ارتباط الشراء",
