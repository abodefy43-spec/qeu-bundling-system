...
PATHS = get_paths()
BUNDLES_PATH = PATHS.output_dir / "final_bundles.csv"
FEEDBACK_PATH = PATHS.data_processed_dir / "bundle_feedback.csv"


def load_bundles():
    if not BUNDLES_PATH.exists():
        print(f"ERROR: No bundles found at {BUNDLES_PATH}")
        print("Run the pipeline first: python -m qeu_bundling.cli run full")
        return []
