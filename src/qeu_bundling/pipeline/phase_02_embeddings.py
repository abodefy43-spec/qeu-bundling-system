...
# Current model: good multilingual coverage, 384 dims, fast inference.
# Evaluated alternative: "paraphrase-multilingual-mpnet-base-v2" (768 dims)
#   - Better Arabic/English cross-lingual quality
#   - ~2x memory and compute cost
#   - Requires full pipeline re-run (Phase 2+) to regenerate embeddings
# Decision: keep MiniLM for now; upgrade when bundle relevance testing
# shows embedding quality is a bottleneck rather than scoring weights.
